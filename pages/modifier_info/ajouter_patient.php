...
//
  ...
  if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `users` (nom,prenom,age,sexe,num_tel,email,adresse,nationalite,rdv_prochain_date,rdv_prochain_temps,cin,passport_num,assurance,assurance_num,username,password,user_type) values('$nom','$prenom','$age','$sexe','$num_tel','$email','$adresse','$nationalite','$rdv_prochain_date','$rdv_prochain_temps','$cin','$passport_num','$assurance','$assurance_num','$username','$password','3')";
            ...
            <form method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" autocomplete="off" name="assurance_num"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="rdv_prochain_date"><input type="time" name="rdv_prochain_temps"><br/></td>
                    </tr>
