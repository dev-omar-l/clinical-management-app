...
/* -------------------------------------------------------- */
  ...
  $password=$row['password'];
    ...
    $num_rows = mysqli_num_rows($result);
        ...
        $sql="UPDATE `users` set user_id='$user_id',nom='$nom',prenom='$prenom',age='$age',sexe='$sexe',num_tel='$num_tel',email='$email',adresse='$adresse',nationalite='$nationalite',cin='$cin',passport_num='$passport_num',salaire='$salaire',username='$username',password='$password' WHERE user_id=$user_id";
...
?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <center>
                <h3>Modification de l'infirmier</h3>
            </center>
            ...
            <form method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><textarea type="text" class="form-control" rows="3" name="adresse" required value=<?php echo $adresse; ?>><?php echo htmlspecialchars(
    $adresse, ENT_QUOTES, 'UTF-8') ?></textarea></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" autocomplete="off" name="salaire" value=<?php echo $salaire ?>></td>
                    </tr>
                    <tr>
